            ...
            {!submitted ? (
              <>
                ...
                <p className="mt-3 text-sm leading-relaxed text-foreground/60">
                  Every business is different, so we tailor pricing to your goals rather than using
                  a one size fits all rate card. Tell us a bit about your business and we’ll come
                  back with a proposal built around you.
                </p>
